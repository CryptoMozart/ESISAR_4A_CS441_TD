...
public class Calculateur {
	...
	public static void main(String[] args) {
		...
		Calculatrice c2 = new Calculatrice(operations);
		...
		c2.ajouterOperation(ajouter);
		c2.ajouterOperation(soustraire);
		c2.ajouterOperation(multiplier);
		c2.ajouterOperation(abs);
		c2.ajouterOperation(max);
